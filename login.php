...
<body class="page-login">
    ...
    <div class="container">
        ...
        <div class="form-header">
            ...
            <p>Войдите, чтобы подать заявку на обучение вождению автобуса, электробуса или трамвая</p>
        </div>
        ...
        <form method="POST" action="" id="loginForm">
            <div class="form-group">
                ...
                <input type="text" id="login" name="login"
                       ...
                       placeholder="driver2026" required autofocus>
            </div>
    ...
    <script>
        ...
        const savedLogin = localStorage.getItem('savedLoginPassazhiram');
        ...
        form.addEventListener('submit', function() {
            ...
            localStorage.setItem('savedLoginPassazhiram', login);
        });
    </script>
</body>
</html>
